...
w1=4
axs[0][0].plot(x_350, y_350, linewidth=2, color = 'limegreen', label = 'Loss of Worker#{}'.format(w1))
axs[0][1].plot(x_350, y_350, linewidth=2, color = 'limegreen', label = 'Loss of Worker#{}'.format(w1))
axs[1][0].plot(x_350, y_350, linewidth=2, color = 'limegreen', label = 'Loss of Worker#{}'.format(w1))
axs[1][1].plot(x_350, y_350, linewidth=2, color = 'limegreen', label = 'Loss of Worker#{}'.format(w1))
...
axs[1][1].axvline(x = 242, linestyle = 'dashed', color = 'r', label = 'Real Convergent Round')
# predict drop round
axs[1][1].axvline(x = 237, linestyle = 'dashdot', color = 'y', label = 'Prediction of Convergent Round')
axs[0][0].axvline(x = 350, linestyle = 'dashdot', color = 'y', label = 'Prediction of Convergent Round')
axs[0][1].axvline(x = 350, linestyle = 'dashdot', color = 'y', label = 'Prediction of Convergent Round')
axs[1][0].axvline(x = 350, linestyle = 'dashdot', color = 'y', label = 'Prediction of Convergent Round')
